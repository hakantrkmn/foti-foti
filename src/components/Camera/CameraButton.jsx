    ...
    <div className="text-center">
      ...
      <button
        ...
        className={`
          ...
          ${isLimitReached 
            ? 'bg-gradient-to-r from-red-500 to-red-600 hover:shadow-xl transform hover:-translate-y-1' 
            : 'bg-gradient-to-r from-blue-500 to-purple-600 hover:shadow-xl transform hover:-translate-y-1'
          }
        `}
      >
        {isLoading ? (
          ...
          <>
            ...
            {isLimitReached ? 'Limit Doldu' : 'Fotoğraf Çek'}
          </>
        )}
      </button>
    </div>
